...
<div class="login-wrapper"  id="signup-content">
    <div class="login-content">
        <a href="#" class="close">x</a>
        <h3>sign up</h3>
	<form method="post" class="submitForm" action="{{route('app-users/create')}}">
		@csrf
		   ...
		   <div class="row">
			<label for="last_name">
			   Last name:
			   <input type="text" name="last_name" id="first_name" placeholder="Jackman" required="required" />
		   </label>
	   </div>
            ...
            <div class="row">
             ...
             <div class="row">
                <label for="password_confirmation">
                    re-type Password:
                    <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Password"  required="required" />
                </label>
            </div>
           <div class="row">

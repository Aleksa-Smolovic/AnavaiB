			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                ...
                <td class="text-center">
                            <img class="rounded" src="{{ $object->image}}" width="60">
											...
											<td class="text-center">
												<form action="{{ route('@extends('layouts.index')
...
@endsection/restore', $object->id) }}" method="POST">
													@method('PUT')
													@csrf
													<button class="btn btn-sm btn-info" type="submit">Povrati</button>
												</form>
								...
								<a class="btn btn-sm btn-warning" href="{{ route('admin/@extends('layouts.index')
...
@endsection') }}"> Objekti</a href="{{ route('admin/@extends('layouts.index')
...
@endsection') }}">
							@else
								<h2>Nema obrisanih objekata, <a class="text-primary" href="{{ route('admin/@extends('layouts.index')
